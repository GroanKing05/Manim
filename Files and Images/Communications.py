...
class Communications(Scene):
    def construct(self):
        ...
        bits69 = bits2.copy()
        bits69.move_to(Chatbox3.get_top() + DOWN*1.6 + RIGHT*0.05)
        ...
        bits69.generate_target()
        bits1.target.move_to(LEFT * 2)
        bits69.target.move_to(LEFT * 2)

        self.play(MoveToTarget(bits1), MoveToTarget(bits69))

        bits_group = VGroup(bits1, bits69)
