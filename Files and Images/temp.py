...
class BasicTextualScene(Scene):
  ...
  # Underline the desired phrase
        ...
        Exp5 = MathTex(r"log(|$\mathbb{F_q}$|)", color=RED).scale(0.9)
        Exp6 = MathTex(r"log(|$\mathbb{F_q}$|)", tex_template=myTemplate, color=RED).scale(0.9)
...
# Write the final statement
        ...
        self.wait(Wiggle(secret_sharing_text))
        self.wait(1)
        self.play(*[FadeOut(mob) for mob in self.mobjects])   
